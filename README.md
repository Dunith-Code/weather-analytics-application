...
### 4–6. ☁️ Cloud Cover, 🔽 Pressure, 👁️ Visibility — self-designed ideal-band scoring
...
- **Cloud Cover** (ideal: 20–60%): partial cloud cover is comfortable (some shade without full overcast); weighted low (5%) since it affects ambience/glare more than physical comfort
- **Pressure** (ideal: 1010–1020 hPa): associated with stable, fair weather; weighted low (5%) since it's a weak, indirect proxy
...
> 📹 **Screen Recording:** [Watch on Google Drive](https://drive.google.com/file/d/1SMDpICkerTlIRGj38tI5f6v56FbcnEGa/view?usp=sharing)
